...
def main():
    ...
    columns = [
        ...
        'train/mae', 'train/mape', 'train/mse', 'train/rmse', 'train/focal', 'train/smooth_l1',
        'val/mae', 'val/mape', 'val/mse', 'val/rmse', 'val/focal', 'val/smooth_l1',
        'test/mae', 'test/mape', 'test/mse', 'test/rmse', 'test/focal', 'test/smooth_l1',
        'note'
    ]
